...
int main(int argc, char **argv)
{
  ...
  Point start_point(250.0,120.0,"start_point",0.0,1.0,0.0,q_start_x,q_start_y,q_start_z,q_start_w); //----------- dziala ----------- 250 i 53 obrot -30
  ...
  Point end_point(310.0,380.0,"end_point",1.0,0.0,0.0,q_goal_x,q_goal_y,q_goal_z,q_goal_w); // ----------- dziala ----------- 320 i 80 obrot 15
